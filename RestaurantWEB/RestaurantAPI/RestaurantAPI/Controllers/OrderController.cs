...
namespace RestaurantAPI.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        {
            return await _context.OrderMaters
        ...
        {
            _context.OrderMaters.Add(orderMaster);
            await _context.SaveChangesAsync();
        ...
        {
            var orderMaster = await _context.OrderMaters.FindAsync(id);
            if (orderMaster == null)
            {
                return NotFound();
            }

            _context.OrderMaters.Remove(orderMaster);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.OrderMaters.Any(e => e.OrderMasterId == id);
        }
    }
}
