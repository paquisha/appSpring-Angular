package com.aekmot.demo.Controllers;
...
import com.aekmot.demo.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		...
		try {
			...
			response.put("mensaje", "Error a l relaizar el insert en la base datos");
			response.put("error", e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage()));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
		response.put("mensaje", "Cliente ha sido creado con exito");
